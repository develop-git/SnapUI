...
public extension SnapViewDSL {
    ...
    func leadingTop(_ value: CombinedLiteral = .default) -> Self {
        return self.leading(value).top(value)
    }
    
    @discardableResult
    func leadingTop(by view: AppView, offset: CombinedLiteral = nil) -> Self {
        return self.leading(by: view, offset: offset).top(by: view, offset: offset)
    }
    
    @discardableResult
    func safeLeadingTop(_ value: CombinedLiteral = .default) -> Self {
        return self.safeLeading(value).safeTop(value)
    }
    
    @discardableResult
    func safeLeadingTop(by view: AppView, offset: CombinedLiteral = nil) -> Self {
        return self.safeLeading(by: view, offset: offset).safeTop(by: view, offset: offset)
    }
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func leadingTop(_ leading: XaxisOffset, _ top: YaxisOffset) -> Self
    {
        return self.leading(leading).top(top)
    }
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func leadingTop(_ leading: CombinedLiteral, _ top: CombinedLiteral) -> Self
    {
        return self.leading(leading).top(top)
    }
    ...
    func leadingBottom(_ value: CombinedLiteral = .default) -> Self {
        return self.leading(value).bottom(value)
    }
    
    @discardableResult
    func leadingBottom(by view: AppView, offset: CombinedLiteral = nil) -> Self {
        return self.leading(by: view, offset: offset).bottom(by: view, offset: offset)
    }
    
    @discardableResult
    func safeLeadingBottom(_ value: CombinedLiteral = .default) -> Self {
        return self.safeLeading(value).safeBottom(value)
    }
    
    @discardableResult
    func safeLeadingBottom(by view: AppView, offset: CombinedLiteral = nil) -> Self {
        return self.safeLeading(by: view, offset: offset).safeBottom(by: view, offset: offset)
    }
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func leadingBottom(_ leading: XaxisOffset, _ bottom: YaxisOffset) -> Self
    {
        return self.leading(leading).bottom(bottom)
    }
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func leadingBottom(_ leading: CombinedLiteral, _ bottom: CombinedLiteral) -> Self
    {
        return self.leading(leading).bottom(bottom)
    }
}
